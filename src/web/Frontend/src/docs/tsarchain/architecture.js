...
> address \`tsar1qakf6mle606amn7xumvz4k6yu6cz0mxq6pe5qwr\` sent 2300 coins + 0,00004900 feeto address \`tsar1qn76f5d32xe9405hsteujjyyuahrcynh5cxjw23\`, then validated by miner \`tsar1qyekatj93lvaq6xr3q9r8zwhkdzmk9hr0fmfrss\` in block height 10
...
> ⚠️ The graffiti data evidence above is still \`under development\`. There are still many things that need to be improved in terms of consensus security, etc.
...
> ℹ️ All of the above data structure evidence uses the \`.json\` storage backend (debugging mode). The default storage model in this project is \`.mdb\` LMDB.`,
      dataStructures: [
        {
          id: "tx-block-data",
  ...
  "version": 1
        ...
        {
          id: "tx-utxo-data",
          title: "2. UTXO's Data Structure (.json)",
          subtitle: "UTXO state mapping txid:vout to address, script_type, and amounts",
          code: `{
  ...
  "88bc192050945f1723ab416d8c53bc1b332d2d8fa737d3dfb26c931df9fc04b5:1": {
    ...
    "tx_out": {
      ...
      "script_pubkey": "0014ed93adff3a7ebbb9f8dcdb055b689cd604fd981a"
        ...
        {
          id: "tx-mempool-data",
          title: "3. MemPool Data Structure (.json)",
  ...
  "txs": [
    {
      ...
      "version": 1
        ...
        },
        {
          ...
          title: "4. Block (graffiti) Data Structure (.json)",
  ...
  "version": 1
        ...
        },
        {
          ...
          title: "5. Block (comment) Data Structure (.json)",
  ...
  "version": 1
        ...
        },
        {
          ...
          title: "6. Block (payouts) Data Structure (.json)",
  ...
  "version": 1
        ...
        },
        {
          ...
          title: "7. Graffiti (metadata) Structure (.json)",
          subtitle: "Graffiti Registry database tracking comments, payouts, posts, and retention proofs",
          code: `{
  "comments": {
    ...
    "grafd99f16dde43a8c2740396ba6a71d8f1666612c4a9790d7060edfe236cfd8": [
      ...
      },
      {
        ...
        },
        {
          ...
          title: "8. Graffiti (indexer) in Storage Node (.json)",
  ...
  "tx_out": {
    ...
    "script_pubkey": "0014266dd5c8b1fb3a0d18710146713af668b762dc6f"
        ...
        },
        {
          ...
          title: "10. State Data Structure (.json)",
