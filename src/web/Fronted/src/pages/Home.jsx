  ...
  <div className="card">
    ...
    <div className="grid">
      ...
      <div className="stat">
        ...
        <span className="value mono wrap">{data?.chainwork ?? "-"}</span>
      </div>
      <div className="stat">
...
const ResultGraffiti = ({ data }) => {
  ...
  return (
    <div className="card">
      ...
      {data?.preview_url ? (
        isVideo ? (
          <video className="media-preview" controls preload="metadata" src={data.preview_url} />
        ) : (
          <img className="media-preview" src={data.preview_url} alt="Graffiti preview" loading="lazy" />
        )
      ) : (
  ...
  return (
    <main className="page">
      <section className="hero">
        ...
        <div className="status-bar">{status === "loading" ? "Loading..." : message || `Deteksi jenis: ${kind}`}</div>
      </section>
